...
var cortar = resultado.slice(0,10); //Escojo solo los 10 primeros objetos 
console.log(cortar);

cortar.forEach(function (elemento) { //a partir de los elementos cortados escojo solo el titulo
  document.write('<li>' + '<strong>' + 'Titulo : ' + '</strong>' + elemento.title + '</li>')
})
